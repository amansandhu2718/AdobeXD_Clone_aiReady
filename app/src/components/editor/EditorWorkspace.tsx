...
export function EditorWorkspace() {
  ...
  const alignSelectedElementToFrame = useEditorStore((state) => state.alignSelectedElementToFrame)
  ...
  function exportProject() {
    downloadText(`${file.project.name}.amanxd.json`, JSON.stringify(file, null, 2))
    setStatus('Project JSON exported')
  }

  function exportHandoff() {
    downloadText(
      `${file.project.name}-handoff.json`,
  ...
  function exportFramePng() {
    const ok = canvasRef.current?.exportSelectedFrame()
    setStatus(ok ? 'Selected frame PNG exported' : 'Select a frame before exporting PNG')
  }

  function exportAllFrames() {
    const count = canvasRef.current?.exportAllFrames({ format: 'png', pixelRatio: 2 }) ?? 0
    setStatus(count ? `Exported ${count} artboard(s)` : 'No artboards exported')
  }

  function exportSelectedJpg() {
    const ok = canvasRef.current?.exportSelectedFrame({ format: 'jpeg', pixelRatio: 2, quality: 0.9 })
    setStatus(ok ? 'Selected frame JPG exported' : 'Select a frame before exporting JPG')
  }

  function exportMarkedAssets() {
    const count = canvasRef.current?.exportMarkedAssets({ format: 'png', pixelRatio: 2 }) ?? 0
    setStatus(count ? `Exported ${count} marked asset(s)` : 'No marked assets found')
  }

  function exportSelectedAsset() {
    const ok = canvasRef.current?.exportSelectedAsset({ format: 'png', pixelRatio: 2 })
    ...
    <main className="app-shell">
      <header className="topbar">
        <div className="topbar-left">
          ...
          <button className="icon-button home-button" onClick={() => setFile(sampleProject)} title="Home" type="button">
            <Home size={15} />
          </button>
          <nav className="menu-bar" aria-label="File and project menus">
            <div className="menu-root">
              ...
              <div className="menu-popover">
                ...
                <button className="menu-item" onClick={exportProject} type="button">
                ...
                <button className="menu-item" onClick={exportFramePng} type="button">
                  Export selected artboard <span className="menu-shortcut">PNG</span>
                </button>
                <button className="menu-item" onClick={exportSelectedJpg} type="button">
                  Export selected artboard <span className="menu-shortcut">JPG</span>
                </button>
                <button className="menu-item" onClick={exportAllFrames} type="button">
                  Export all artboards <span className="menu-shortcut">PNG 2x</span>
                </button>
                <button className="menu-item" onClick={exportSelectedAsset} type="button">
                  Export selected asset <span className="menu-shortcut">PNG</span>
                </button>
                <button className="menu-item" onClick={exportMarkedAssets} type="button">
                  Batch export marked assets <span className="menu-shortcut">PNG</span>
                </button>
                <button className="menu-item" onClick={exportHandoff} type="button">
            ...
            <div className="menu-root">
              ...
              <div className="menu-popover">
                ...
                <div className="menu-separator" />
                <button className="menu-item" onClick={() => alignSelectedElementToFrame('left')} type="button">
                  Align left
                </button>
                <button className="menu-item" onClick={() => alignSelectedElementToFrame('center')} type="button">
                  Align center
                </button>
                <button className="menu-item" onClick={() => alignSelectedElementToFrame('right')} type="button">
                  Align right
                </button>
                <button className="menu-item" onClick={() => alignSelectedElementToFrame('top')} type="button">
                  Align top
                </button>
                <button className="menu-item" onClick={() => alignSelectedElementToFrame('middle')} type="button">
                  Align middle
                </button>
                <button className="menu-item" onClick={() => alignSelectedElementToFrame('bottom')} type="button">
                  Align bottom
                </button>
              </div>
            </div>
        ...
        <div className="project-title">
          <div className="menu-root project-menu">
            ...
            <div className="menu-popover">
              ...
              <button className="menu-item is-disabled" disabled type="button">
                Rename project <span className="menu-shortcut">Soon</span>
              </button>
              <button className="menu-item is-disabled" disabled type="button">
        ...
        <div className="top-actions">
          ...
          <button className="icon-button" onClick={exportProject} title="Export project JSON" type="button">
            <FileJson size={15} />
          </button>
          <button className="icon-button" onClick={exportFramePng} title="Export selected artboard PNG" type="button">
            <ImageDown size={15} />
          </button>
          <button className="icon-button" onClick={exportHandoff} title="Export handoff metadata" type="button">
            <Download size={15} />
          </button>
